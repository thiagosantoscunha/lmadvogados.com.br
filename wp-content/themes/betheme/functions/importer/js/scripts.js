(function($) {
  ...
  $(function() {
    ...
    $('.demos', importer).on('click', '.mfn-button-import', function(e) {
      ...
      $('.popup-step.step-2 input', popup).prop('checked', false);
      $('.popup-step.step-2 input.checked', popup).prop('checked', 'checked');
    ...
    $('.import-options', popup).on('click', 'label', function() {
      ...
      $('input.radio-type', parent).prop('checked', 'checked');
